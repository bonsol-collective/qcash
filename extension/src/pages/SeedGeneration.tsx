    ...
    <div className="min-h-screen bg-slate-950 p-6 text-slate-100 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md space-y-6">
        <div className="text-center space-y-2">
          <h2 className="text-2xl font-bold bg-clip-text text-transparent bg-linear-to-r from-violet-400 to-cyan-400">
            Recovery Phrase
          </h2>
        ...
        <div className="grid grid-cols-3 gap-3 w-full my-6">
          {mnemonicList.map((word, i) => (
            <div
              key={i}
              className="bg-slate-900/50 border border-slate-800 p-2.5 rounded-lg text-center text-sm font-mono group hover:border-slate-700 transition-colors"
            >
